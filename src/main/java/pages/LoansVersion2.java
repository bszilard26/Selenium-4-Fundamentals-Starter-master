...
public class LoansVersion2 {
    ...
    private LoansVersion2(WebDriver driver){this.driver = driver;}
    public static LoansVersion2 loansPage(WebDriver driver){return new LoansVersion2(driver);}
    ...
    public LoansVersion2 selectTimePeriod(Period period) {
